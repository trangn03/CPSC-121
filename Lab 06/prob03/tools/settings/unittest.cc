...
TEST(CombineBubbles, SameRadius) {
  ...
  ASSERT_EQ(CombineBubble(first_bubble, second_bubble).GetRadius(), 12.4)
  ...
  ASSERT_DOUBLE_EQ(CombineBubble(first_bubble, second_bubble).CalculateVolume(), 7986.2123946666661)
...
TEST(CombineBubbles, DifferentRadius) {
  ...
  ASSERT_EQ(CombineBubble(first_bubble, second_bubble).GetRadius(), 9)
  ...
  ASSERT_DOUBLE_EQ(CombineBubble(first_bubble, second_bubble).CalculateVolume(), 3053.5379999999996)
