...
OTHER_IMPLEMS	:= cpputils/graphics/image.cc #game.o main.o
# Space-separated list of implementation files that should be used for testing.
OTHER_TEST_IMPLEMS	:= cpputils/graphics/image.cc
# Space-separated list of header files (e.g., algebra.hpp)
HEADERS      		:= objects.h game.h
# Space-separated list of implementation files (e.g., algebra.cpp)
IMPLEMS       		:= objects.cc game.cc
